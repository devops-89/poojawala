...
export default function CustomerBookingDetailsContent({
  bookingId,
}: {
  ...
  const handleRescheduleBooking = async () => {
    ...
    const customerAddressId =
      booking?.customerAddressId || booking?.customerAddress?.id;
    ...
    try {
      ...
      console.error(error);
      showSnackbar(
        error.response?.data?.message || "Error rescheduling booking",
        "error",
      );
    } finally {
  ...
  const formattedAmount = useMemo(() => {
    const amt =
      booking?.finalAmount ?? booking?.finalamount ?? booking?.agreedPrice;
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
        ...
        <Grid container spacing={4}>
          ...
          {(booking.purohitReview ||
            (booking.purohitRating && booking.purohitRating !== "0.0")) && (
            <Grid size={{ xs: 12, lg: 6 }}>
      ...
      >
        ...
        <DialogContent sx={{ mt: 1 }}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3, py: 1 }}>
            ...
            >
              Please select a new date and time and provide a reason for the
              reschedule.
            </Typography>
        ...
        <DialogActions sx={{ p: 2, pt: 0 }}>
          ...
          <Box
            ...
            sx={{
              ...
              border: "none",
              cursor:
                isRescheduling || !newScheduleTime || !rescheduleReason
                  ? "not-allowed"
                  : "pointer",
              px: 2.5,
              py: 1,
