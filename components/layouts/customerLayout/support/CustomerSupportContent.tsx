  ...
  const faqs = [
    {
      ...
      a: 'Refunds are processed within 3-5 business days. You can track the status in the "My Bookings" section under the specific cancelled puja.',
    },
    {
      q: "Can I reschedule a puja?",
      a: "Yes, you can reschedule your puja up to 24 hours before the scheduled time without any extra charges.",
    },
    {
      q: "What if the purohit doesn't arrive?",
      a: "In the rare event of a no-show, please raise a ticket immediately. We will arrange a replacement or process a full refund.",
    },
  ];
                      ...
                      {complaints.map((complaint) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell>
                              <span
                                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold ${getStatusColor(complaint.status)}`}
                              >
          ...
          {loadingDetails ? (
            ...
            <Grid container spacing={3}>
              <Grid size={{ xs: 12, md: 6 }}>
                <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  <Box>
                    ...
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold ${getStatusColor(selectedComplaint.status)}`}
                    >
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                >
                  <SubjectIcon
                    sx={{ fontSize: 20, color: "#64748b", mt: 0.2 }}
                  />
                  <Typography
                    sx={{
                      fontSize: 14,
              ...
              {selectedComplaint.evidenceUrls &&
                selectedComplaint.evidenceUrls.length > 0 && (
                  <Grid size={{ xs: 12, md: 6 }}>
                    ...
                    >
                      {selectedComplaint.evidenceUrls.map(
